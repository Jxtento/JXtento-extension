  ...
  if (connected) {
    return (
      <div className="flex flex-col gap-2">
        <div className="flex items-center justify-between px-3 py-1.5 rounded bg-jxtento-good text-jxtento-bg text-sm font-medium">
          <div className="flex items-center gap-2">
            <div className="w-2 h-2 rounded-full bg-jxtento-bg animate-pulse" />
    ...
    <div className="flex flex-col gap-2">
      <div className="flex gap-2">
        <button
          ...
          disabled={loading}
          className="flex-1 px-3 py-1.5 rounded bg-jxtento-border text-white hover:bg-jxtento-muted transition-colors text-sm"
        >
      ...
      {error && <div className="text-xs text-jxtento-warn">{error}</div>}
    </div>
  );
}
